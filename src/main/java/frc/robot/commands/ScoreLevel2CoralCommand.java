...
public class ScoreLevel2CoralCommand extends SequentialCommandGroup {
  /** Creates a new ScoreLevel4Coral. */
  public ScoreLevel2CoralCommand(
    ...
    addCommands(
      ...
      new MoveElevatorCommand(elevatorSubsystem, ElevatorConstants.Lvl2Position),
      new MoveArmCommand(armSubsystem, ArmConstants.Lvl2Position),
