...
public class ScoreLevel4CoralCommand extends SequentialCommandGroup {
  /** Creates a new ScoreLevel4Coral. */
  public ScoreLevel4CoralCommand(
    ...
    addCommands(
      ...
      new MoveElevatorCommand(elevatorSubsystem, ElevatorConstants.Lvl4Position),
      new MoveArmCommand(armSubsystem, ArmConstants.Lvl4Position),
