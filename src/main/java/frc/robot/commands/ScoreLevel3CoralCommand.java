...
public class ScoreLevel3CoralCommand extends SequentialCommandGroup {
  /** Creates a new ScoreLevel4Coral. */
  public ScoreLevel3CoralCommand(
    ...
    addCommands(
      ...
      new MoveElevatorCommand(elevatorSubsystem, ElevatorConstants.Lvl3Position),
      new MoveArmCommand(armSubsystem, ArmConstants.Lvl3Position),
