...
public final class ArmConstants {
  ...
  public static final class Positions {
    ...
    public static final double CORAL2 = 3.0;
    public static final double CORAL3 = 3.0;
    public static final double CORAL4 = 5.7;
    public static final double ALGAEMOVE = 18.001465;
    public static final double ALGAE1 = 18.001465;
    public static final double ALGAE2 = 18.001465;
    public static final double ALGAEPROCESSOR = 19.001465;
    public static final double ALGAENET = 19.001465;
    public static final double MAX = 25.0; // Absolute maximum
  }
   ...
   */
  public static final double kDegreesPerRotation = kSpoolCircumferenceInches / kGearRatio;
  ...
  /**
   * Integral gain
   * Usually not needed for arm with good kG tuning
  ...
  /**
   * Gravity feedforward (CRITICAL for arms!)
   * This is the voltage needed to hold the arm at any position
   * 
   * Tuning process:
   * 1. Set kP=0, kG=0, manually move arm to mid-height
  ...
  /**
   * How close to target before considering "at position" (degrees)
   */
  public static final double kPositionToleranceDegrees = 1.5;
   ...
   *    - Move arm to mid-height manually
