...
public final class Constants {
  ...
  public static class DIOConstants {
    public static final int kBeamBreakSensorID = 0;
  }
  ...
  public static class FieldConstants {
    ...
    public static final HashMap<Integer, Pose2d> kLeftScoringPoses = getLeftScoringPoses();
    public static final HashMap<Integer, Pose2d> kRightScoringPoses = getRightScoringPoses();
